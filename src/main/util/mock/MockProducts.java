...
public class MockProducts {
    ...
    public static Supplier<Product> getDefaultProduct = () ->  new Product(0, "Mousepad", "Mousepad Gamer VTX", 3, Category.HARDWARE, LocalDate.of(2022, 06, 22), 55.70);
